...
function NoteList(t0) {
    ...
    if ($[0] !== "cdb973e4cc999151f4d7e485ed976fdaff582f5dc4beb87c15a45fc5eaab8793") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cdb973e4cc999151f4d7e485ed976fdaff582f5dc4beb87c15a45fc5eaab8793";
    }
    const { notes } = t0;
...
function NotesClient(t0) {
    ...
    if ($[0] !== "552db9aa81c7137acbd03cd26a563f3b6b6849d20633e984b9ab15324c7de579") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "552db9aa81c7137acbd03cd26a563f3b6b6849d20633e984b9ab15324c7de579";
    }
    const { slug } = t0;
    ...
    let t4;
    if ($[6] !== category || $[7] !== currentPage || $[8] !== name) {
        t4 = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNotes"])(name, currentPage, category);
        $[6] = category;
        $[7] = currentPage;
        $[8] = name;
        $[9] = t4;
 ...
 //   );
 // }
_s(NotesClient, "USCBOMSAcxb5mToxth289kslDmw=", false, function() {
    return [
...
//# sourceMappingURL=_2402e6aa._.js.map